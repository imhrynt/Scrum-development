 ...
 <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">SCRUM <sup>2</sup></div>
        </a>
        ...
        <hr class="sidebar-divider my-0">
        <li class="nav-item @if(request()->is('reports' . '*')) active @endif">
            <a class="nav-link" href="/about"><i class="fas fa-fw fa-info"></i><span>Tentang</span></a>
        </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; scrum 2023</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Pilih "Keluar" di bawah ini jika ingin keluar dari aplikasi ini.</div>
